APIPARAMS = ('cht', 'chbh', 'chtt', 'chdl', 'chco', 'chd', 'chs', 'chf', 'chts', 'chl', 'chxt', 'chxl', 'chg', 'chxr', 'chxs', 'chls', 'chm', 'chxp', 'chp', 'chds', 'chtm', 'chld')
...
TTITLES = ('Line','Line XY','Horizontal bar stack','Vertical bar stack','Horizontal bar group','Vertical bar group','Pie','3D Pie','Venn','Scatter','Radar','Map','Meter','Sparkline')
